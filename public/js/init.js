var requirejs, require, devDefine;
! function (global) {
    ...
    function newContext(e) {
        ...
        function a(e, t, i, n) {
            ...
            return e || (l = !1, e = "_@r" + (A += 1)), c = o(e), d = c[0], e = c[1], d && (d = r(d, p, n), s = getOwn(j, d)), e && (d ? h = s && s.normalize ? s.normalize(e, function (e) {
                return r(e, p, n)
            }) : -1 === e.indexOf("!") ? r(e, p, n) : e : (h = r(e, p, n), c = o(h), d = c[0], h = c[1], i = !0, a = q.nameToUrl(h))), u = !d || s || i ? "" : "_unnormalized" + (D += 1), {
                    prefix: d,
                    name: h,
                    parentMap: t,
                    unnormalized: !!u,
                            ...
                            if (this.defining = !0, this.depCount < 1 && !this.defined) {
                                if (isFunction(o)) {
                                    ...
                                    if (this.map.isDefine && void 0 === n && (t = this.module, t ? n = t.exports : this.usingExports && (n = this.exports)), e) {
                                        if (this.events.error && this.map.isDefine || req.onError !== defaultOnError) return e.requireMap = this.map, e.requireModules = this.map.isDefine ? [this.map.id] : null, e.requireType = this.map.isDefine ? "devDefine" : "require", c(this.error = e);
...
require(
    ...
    function () {
        ...
        Object.defineProperty(getToKnowBo, "answer", {
        ...
        function loadTask(response) {
            if (response.error) {
                ...
                if (response.keyWord) {
                    getToKnowBo.keyWord = response.keyWord;
